...
public class blueauto extends LinearOpMode {
    ...
    double startX = 18.905;
    double startY = 120.487;
    double startHeading = Math.toRadians(144);
    //--------------------------------------------
    ...
    public void buildpaths(){
        Path1 = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(18.905, 120.487),

                                new Pose(51.615, 112.672)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(144), Math.toRadians(70))
        ...
        Path5 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(17.558, 84.002),
                                new Pose(34.008, 79.744),
                                new Pose(17.216, 72.758)
                        )
        ...
        Path6 = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(55.961, 95.564)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(230))
        ...
        Path9 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(11.556, 58.057),
                                new Pose(42.524, 64.209),
                                new Pose(56.439, 96.329)
                        )
