...
public class BLUE_CLOSE_9S extends LinearOpMode {
    //Drivetrain
    ...
    private final Pose startPose = new Pose(18.904872298624767, 120.48707269155206, Math.toRadians(144));
...
//            telemetry.update();
    ...
    public void buildPaths(){
        ...
        Path2 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(70), Math.toRadians(143))
